defmodule Epicenter.AuditLog.Revision do
  ...
  def profile_exposure_note_deletion_event(), do: "profile-exposure-note-deletion"
  def profile_exposure_note_submission_event(), do: "profile-exposure-note-submission"
