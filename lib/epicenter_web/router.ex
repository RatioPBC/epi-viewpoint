defmodule EpicenterWeb.Router do
  ...
  scope "/", EpicenterWeb do
    ...
    live(
      "/case-investigations/:id/complete-interview",
      InvestigationCompleteInterviewLive,
      :complete_case_investigation,
      as: :case_investigation_complete_interview
    )

    live(
      "/case-investigations/:id/conclude-isolation-monitoring",
      CaseInvestigationConcludeIsolationMonitoringLive,
    ...
    live(
      "/case-investigations/:id/isolation-monitoring",
      CaseInvestigationIsolationMonitoringLive,
      as: :case_investigation_isolation_monitoring
    )

    live("/case-investigations/:id/isolation-order", CaseInvestigationIsolationOrderLive, as: :case_investigation_isolation_order)

    live("/case-investigations/:id/place", PlaceLive, as: :new_place)
    live("/case-investigations/:id/place-search", PlaceSearchLive, as: :place_search)
    live("/case-investigations/:case_investigation_id/add-visit", AddVisitLive, as: :add_visit)
    ...
    live(
      "/contact-investigations/:id/complete-interview",
      InvestigationCompleteInterviewLive,
    ...
    live(
      "/contact-investigations/:id/conclude-quarantine-monitoring",
      ContactInvestigationConcludeQuarantineMonitoringLive,
      as: :contact_investigation_conclude_quarantine_monitoring
    )

    live(
      "/contact-investigations/:id/quarantine-monitoring",
