defmodule EpiViewpointWeb.Format do
  ...
  def person(nil), do: ""
  def person(%EpiViewpoint.Cases.Person{} = person), do: person(EpiViewpoint.Cases.Person.coalesce_demographics(person))
  ...
  defp to_date(%DateTime{} = date_time) do
    date_time |> DateTime.shift_zone!(EpiViewpointWeb.PresentationConstants.presented_time_zone()) |> DateTime.to_date()
  end
