defmodule EpiViewpointWeb.Presenters.CaseInvestigationPresenter do
    ...
    items =
      if case_investigation.isolation_concluded_at do
        [
          %{
            text:
              "Concluded isolation monitoring on #{concluded_isolation_monitoring_date(case_investigation)}. #{Gettext.gettext(EpiViewpoint.Gettext, case_investigation.isolation_conclusion_reason)}",
