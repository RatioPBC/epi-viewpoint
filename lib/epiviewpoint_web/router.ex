defmodule EpiViewpointWeb.Router do
  use EpiViewpointWeb, :router

  import EpiViewpointWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {EpiViewpointWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: EpiViewpointWeb.Telemetry
    end
  end
end
