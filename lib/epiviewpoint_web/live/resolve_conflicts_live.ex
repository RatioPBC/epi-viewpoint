defmodule EpiViewpointWeb.ResolveConflictsLive do
  ...
  def mount(%{"id" => person_id, "duplicate_person_ids" => comma_separated_duplicate_person_ids} = _params, session, socket) do
    ...
    merge_conflicts = EpiViewpoint.Cases.Merge.merge_conflicts(person_ids, socket.assigns.current_user, merge_fields)
