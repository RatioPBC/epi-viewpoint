defmodule EpiViewpointWeb.Styleguide.StyleguideLive do
  use EpiViewpointWeb, :live_view

  import EpiViewpointWeb.LiveHelpers, only: [assign_defaults: 1, assign_page_title: 2, noreply: 1, ok: 1]
  import EpiViewpointWeb.IconView
  ...
  @address_data EpiViewpointWeb.Styleguide.AutocompleteData.generate_address_data()
