defmodule EpiViewpointWeb.ContactInvestigationClinicalDetailsLive do
  ...
  import EpiViewpointWeb.Presenters.CaseInvestigationPresenter, only: [symptoms_options: 0]
