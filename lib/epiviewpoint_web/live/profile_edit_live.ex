defmodule EpiViewpointWeb.ProfileEditLive do
  use EpiViewpointWeb, :live_view

  import EpiViewpointWeb.IconView, only: [plus_icon: 0, arrow_down_icon: 0, back_icon: 0, trash_icon: 0]
  import EpiViewpointWeb.LiveHelpers, only: [assign_defaults: 1, assign_page_title: 2, authenticate_user: 2, noreply: 1, ok: 1]
  import EpiViewpointWeb.PersonHelpers, only: [demographic_field: 2]
  ...
  defmodule FormData do
    ...
    embedded_schema do
      ...
      embeds_many :phones, EpiViewpoint.Cases.Phone, on_replace: :delete
      embeds_many :emails, EpiViewpoint.Cases.Email, on_replace: :delete
      embeds_many :addresses, EpiViewpoint.Cases.Address, on_replace: :delete
    end
  end
  ...
  defp validate(changeset) do
    ...
    |> EpiViewpoint.PhiValidation.validate_phi(:demographic)
  end
