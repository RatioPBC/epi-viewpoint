defmodule EpiViewpointWeb.PeopleFilter do
...
defmodule EpiViewpointWeb.PeopleLive do
  ...
  import EpiViewpointWeb.Presenters.CaseInvestigationPresenter, only: [displayable_status: 2]

  alias EpiViewpoint.Accounts
  alias EpiViewpoint.AuditLog
  alias EpiViewpoint.CaseInvestigationFilterError
