defmodule EpiViewpoint.DateParserTest do
  ...
  describe "parse_mm_dd_yyyy" do
    ...
    test "has a ! version" do
      ...
      assert_raise EpiViewpoint.DateParsingError, "Invalid mm-dd-yyyy format: glorp", fn -> DateParser.parse_mm_dd_yyyy!("glorp") end
    end
  end
end
