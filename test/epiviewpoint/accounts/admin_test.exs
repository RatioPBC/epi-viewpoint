defmodule EpiViewpoint.Accounts.AdminTest do
  ...
  setup do
    ...
    unpersisted_admin = %User{id: Application.get_env(:epiviewpoint, :unpersisted_admin_id)}
  ...
  describe "insert_by_admin and insert_by_admin!" do
    ...
    test "fails when the author is not an admin",
      ...
      assert_raise EpiViewpoint.AdminRequiredError, "Action can only be performed by administrators", fn ->
