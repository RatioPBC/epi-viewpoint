defmodule Epicenter.Cases.ImportTest do
  ...
  describe "from_csv" do
    test "creates LabResult records and Person records from csv data" do
      """
      first_name , last_name , dob        , thing, sample_date , result_date , result   , glorp , person_tid , lab_result_tid
      Alice      , Ant       , 01/02/1970 , graz , 06/01/2020  , 06/03/2020  , positive , 393   , alice      , alice-result-1
      Billy      , Bat       , 03/04/1990 , fnord, 06/06/2020  , 06/07/2020  , negative , sn3   , billy      , billy-result-1
      """
      |> Import.from_csv()
