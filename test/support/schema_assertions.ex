defmodule EpiViewpoint.Test.SchemaAssertions do
  import ExUnit.Assertions

  alias EpiViewpoint.Test.SchemaAssertions.Database
  alias EpiViewpoint.Test.SchemaAssertions.Schema
  ...
  defmodule Schema do
    ...
    def module_name(module, :drop_prefix),
      do: module |> module_name() |> String.split(".") |> Enum.reject(&(&1 in ~w{EpiViewpoint EpiViewpointWeb})) |> Enum.join(".")
