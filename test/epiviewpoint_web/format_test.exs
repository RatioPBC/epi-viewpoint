defmodule EpiViewpointWeb.FormatTest do
  ...
  describe "address" do
    import EpiViewpointWeb.Format, only: [address: 1]
  ...
  describe "date (with default)" do
    import EpiViewpointWeb.Format, only: [date: 2]
  ...
  describe "date" do
    import EpiViewpointWeb.Format, only: [date: 1, date: 2]
  ...
  describe "date_time_with_zone" do
    import EpiViewpointWeb.Format, only: [date_time_with_zone: 1]
  ...
  describe "date_time_with_presented_time_zone" do
    import EpiViewpointWeb.Format, only: [date_time_with_presented_time_zone: 1, date_time_with_zone: 1]
  ...
  describe "demographic" do
    import EpiViewpointWeb.Format, only: [demographic: 2]
  ...
  describe "person" do
    import EpiViewpointWeb.Format, only: [person: 1]
  ...
  describe "phone" do
    import EpiViewpointWeb.Format, only: [phone: 1]
  ...
  describe "time" do
    import EpiViewpointWeb.Format, only: [time: 1]
